...
class MainLayout(FloatLayout):
    ...
    def insert_image(self):
        ...
        database_params = {
				'var_name'        : 'zhongli','var_group_type'  : 'pyro',
                'var_image_data'  : self.imageToBlob('D:\Dir\python\Codemy\KivyMD-Sandberg\hotreload\Dynamic Loading\Images\Zhongli_Icon.webp'),
